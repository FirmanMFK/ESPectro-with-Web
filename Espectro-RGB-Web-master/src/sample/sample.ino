...
//Wifi name & pass
const char *ssid = "BINTANG_KOST";
const char *password = "bintangpagar";
...
void handleRoot()
{
    String out = "<html><head><title>#UwaCoding</title></head>";
    out += "<body style='background-color:gray'>";
    out += "<span style='display:block; width:100%; font-size:2em; font-family:Verdana; text-align:center'>#UwaCoding Demo RGB Web</span><br/>";
